...
import com.xs.config.MinioProperties;
import io.minio.*;
...
public class MinioUtil {
    ...
    public FileUploadResponse uploadFile(MultipartFile file, String bucketName) throws Exception {
        ...
        System.out.println("上传文件成功url ：[{"+url+"}], urlHost ：[{"+urlHost+"}]");
